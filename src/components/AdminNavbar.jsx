...
export function AdminNavbar({ activeTab, onTabChange, onLogout }) {
  ...
  return (
    <div className="top-16 left-0 right-0 z-40 border-b border-slate-200 bg-white shadow-md backdrop-blur-sm">
            ...
            <div className="flex gap-1 px-4">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`whitespace-nowrap px-3 py-3 text-xs md:text-sm font-semibold transition-all flex items-center gap-1 rounded-md ${
                    activeTab === tab.id
